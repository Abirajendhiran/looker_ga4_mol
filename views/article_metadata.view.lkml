...
view: article_metadata {
  derived_table: {
    sql: SELECT
          mailonline_articles_metadata.article_id  AS mailonline_articles_metadata_article_id,
          mailonline_articles_metadata.adservable  AS mailonline_articles_metadata_adservable,
          mailonline_articles_metadata.article_text  AS mailonline_articles_metadata_article_text,
          mailonline_articles_metadata.article_word_count  AS mailonline_articles_metadata_article_word_count,
          mailonline_articles_metadata.articles_source_id  AS mailonline_articles_metadata_articles_source_id,
          mailonline_articles_metadata.author_name  AS mailonline_articles_metadata_author_name,
          mailonline_articles_metadata.byline  AS mailonline_articles_metadata_byline,
              (DATE(mailonline_articles_metadata.created_date )) AS mailonline_articles_metadata_created_date,
          mailonline_articles_metadata.created_month  AS mailonline_articles_metadata_created_month,
          mailonline_articles_metadata.current_paywall_status  AS mailonline_articles_metadata_current_paywall_status,
          mailonline_articles_metadata.days_since_first_pub  AS mailonline_articles_metadata_days_since_first_pub,
          mailonline_articles_metadata.dm_source  AS mailonline_articles_metadata_dm_source,
